...
namespace LMS.Web.Controllers
{
    ...
    public class DocumentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DocumentName,Description,LogDate,PathLog,UserId")] Document document)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DocumentName,Description,LogDate,PathLog,UserId")] Document document)
        {
            if (id != document.Id)
            {
                return NotFound();
